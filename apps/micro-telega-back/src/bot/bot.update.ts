...
import { Command, Ctx, Hears, Help, InjectBot, Message, On, Sender, Start, TELEGRAF_BOT_NAME, Update } from 'nestjs-telegraf';
...
import { MENU_MAIN, TelegramBotName } from './bot.constants';
...
export class BotUpdate {
  constructor(
    //@InjectBot(TelegramBotName) private readonly bot: Telegraf<Context>,
